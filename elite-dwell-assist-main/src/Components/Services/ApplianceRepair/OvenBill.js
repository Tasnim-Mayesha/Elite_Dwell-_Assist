        ...
        <div className="grid grid-cols-2">
          <div className="ml-10">
            <div className="time-slot-container pt-20">
              ...
              <select
                className="input input-bordered input-sm border-gray-300"
          ...
          <div className="absolute top-[220px] left-[27.5px] w-[376px] h-[137px]">
            ...
            <div className="absolute h-8 w-24 bottom-2 left-28 text-sm">
              ...
              <button
                ...
                id="tv_power_plus"
                onClick={() => {
                  setovenServicing(ovenServicing + 1);
                  handleServiceSelect("TV Power Supply Problem");
                }}
              >
                <span className="text-2xl">+</span>
          ...
          <div className="absolute top-[390px] left-[27px] w-[376px] h-[137px]">
            ...
            <div className="absolute h-8 w-24 bottom-2 left-28 text-sm">
              <button
                ...
                onClick={() => {
                  setovenRepairing(Math.max(ovenRepairing - 1, 0));
                  handleServiceSelect("TV Mounting");
                }}
              >
                <span className="text-2xl">-</span>
              ...
              <button
                ...
                id="tv_mounting_plus"
                onClick={() => {
                  setovenRepairing(ovenRepairing + 1);
                  handleServiceSelect("TV Mounting");
                }}
              >
                <span className="text-2xl">+</span>
          ...
          <div className="absolute top-[50px] left-[27px] w-[376px] h-[137px]">
            ...
            <div className="absolute h-8 w-24 bottom-2 left-28 text-sm">
              <button
                ...
                id="tv_sound_minus"
                onClick={() => {
                  setovenChecking(Math.max(ovenChecking - 1, 0));
                  handleServiceSelect("TV Sound Problem");
                }}
              >
                <span className="text-2xl">-</span>
              ...
              <button
                ...
                id="tv_sound_plus"
                onClick={() => {
                  setovenChecking(ovenChecking + 1);
                  handleServiceSelect("TV Sound Problem");
                }}
              >
                <span className="text-2xl">+</span>
